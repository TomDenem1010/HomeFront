...
public class VideoController {
  ...
  private List<VideoDto> findVideos() {
    return videoClient
        .findVideos((FindVideosRequest) setHeader(new FindVideosRequest()))
        .getResponse()
        .getVideos();
  }
  ...
  private List<VideoDto> findByFolder(String folder) {
    ...
    return videoClient
        .findByFolder((FindByFolderRequestWrapper) setHeader(wrapper))
        .getResponse()
        .getVideos();
  }
  ...
  private List<VideoDto> findByActor(String actor) {
    ...
    return videoClient
        .findByActor((FindByActorRequestWrapper) setHeader(wrapper))
        .getResponse()
        .getVideos();
  }
  ...
  private List<FolderDto> findFolders() {
    return videoClient
        .findFolders((FindFoldersRequest) setHeader(new FindFoldersRequest()))
        .getResponse()
        .getFolders();
  }
  ...
  private List<ActorDto> findActors() {
    return videoClient
        .findActors((FindActorsRequest) setHeader(new FindActorsRequest()))
        .getResponse()
        .getActors();
  }
